...
using LaptopStore_2.Client.Infrastructure.Managers.Communication;
using LaptopStore_2.Shared.Constants.Storage;

namespace LaptopStore_2.Client.Pages.Communication
{
