...
using LaptopStore_2.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace LaptopStore_2.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
