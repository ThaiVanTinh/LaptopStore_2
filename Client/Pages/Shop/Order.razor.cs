...
namespace LaptopStore.Client.Pages.Shop
{
    public partial class Order
    {
        ...
        {
            await JS.InvokeVoidAsync("localStorage.setItem", "OrderItem", System.Text.Json.JsonSerializer.Serialize(cartItems));
        }
        ...
        private async Task Checkout()
        {
            ...
            var order = new Domain.Entities.Catalog.Order
            {
                ...
                IsPayment = SelectedPaymentMethod != "COD", // Check payment type
