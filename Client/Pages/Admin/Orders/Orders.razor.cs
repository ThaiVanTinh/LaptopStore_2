    ...
    public partial class Orders 
    {
        ...
        private async Task GetOrdersAsync()
        {
            ...
            if (response.Succeeded)
            {
                ...
                {
                    Console.WriteLine($"Order ID: {order.Id}, UserName: {order.UserName}, UserPhone: {order.UserPhone}");
                }
            }
            else
            {
        ...
        {
            var order = _orderList.FirstOrDefault(o => o.Id == orderId);
            if (order != null && order.OrderItem != null)
            {
                var parameters = new DialogParameters
        {
            ...
            {
                _snackBar.Add("No products found for this order.", Severity.Warning);
            }
        }
